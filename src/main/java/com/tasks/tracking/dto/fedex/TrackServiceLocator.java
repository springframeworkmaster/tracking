...
public class TrackServiceLocator extends org.apache.axis.client.Service implements TrackService {
    ...
    private java.lang.String TrackServicePort_address = "http://localhost:7001/web-services/track";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://fedex.com/ws/track/v14", "TrackService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://fedex.com/ws/track/v14", "TrackServicePort"));
        }
